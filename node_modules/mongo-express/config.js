...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    ...
    port:     27017,
    ssl:      false,
    url:      'mongodb://localhost:27017/led',
    username: '',
  };
}
...
module.exports = {
  mongodb: {
    ...
    admin: true, //process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN ? process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN.toLowerCase() === 'true' : false,
